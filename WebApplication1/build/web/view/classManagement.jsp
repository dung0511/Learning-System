...
<html lang="en">
    ...
    <body class="skin-black">
                ...
                <div class="container-xl">
                    <form action = "clist" id = "form">
                        <div class = "search">                 
                            ...
                            <div class = "sj">
                                <select name = "subject" onchange = "sbmit()">
                                    <option value = "0">All subject</option>
                                    <c:forEach items = "${requestScope.listSJ}" var = "i">
                                        <option value = "${i.getSubjectID()}" ${(requestScope.subject == i.getSubjectID())?"selected":""}>${i.getSubjectCode()}</option>
                                    </c:forEach>
                                </select>
                            ...
                            <input type ="hidden" name ="act" value ="list"/>
                            <div class = "sj">
                                <select name = "sem" onchange = "sbmit()">
                            ...
                            <div class = "sj">
                                <select name = "trainer" onchange = "sbmit()">
                                    <option value = "0">All trainer</option>
                                    <c:forEach items = "${requestScope.listT}" var = "i">
                                        ${i.getID()}
                                        <option value = "${i.getID()}" ${(requestScope.trainer == i.getID())?"selected":""}>${i.getFullName()}</option>
                                    </c:forEach>
                                </select>
                            </div>

                            <div class = "sj">
                                <select name = "status" onchange = "sbmit()">
                            ...
                            <input type ="hidden" name ="order" id ="order" value = "${requestScope.order}"/>
                        </div>
                                ...
                                <table class="table table-striped table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th onclick = "sort('Subject')">
                                                Subject
                                                <br/>
                                                <c:if test = "${requestScope.sort == 'Subject' && requestScope.order == 1}">
                                                    <img class ="sort" src ="img/upIcon.png"/>
                                                </c:if>
                                                <c:if test = "${requestScope.sort == 'Subject' && requestScope.order == 0}">
                                                    <img class ="sort" src ="img/downIcon.png"/>
                                                </c:if> 
                                                <c:if test = "${requestScope.sort != 'Subject'}">
                                                    <img class ="sort" src =""/>
                                                </c:if> 
                                            </th>

                                            <th onclick = "sort('Semester')">
                                                Semester 
                                                <br/>
                                                <c:if test = "${requestScope.sort == 'Semester' && requestScope.order == 1}">
                                                    <img class ="sort" src ="img/upIcon.png"/>
                                                </c:if>
                                                <c:if test = "${requestScope.sort == 'Semester' && requestScope.order == 0}">
                                                    <img class ="sort" src ="img/downIcon.png"/>
                                                </c:if> 
                                                <c:if test = "${requestScope.sort != 'Semester'}">
                                                    <img class ="sort" src =""/>
                                                </c:if> 
                                            </th>
                                            <th onclick = "sort('SD')">
                                                Start Date 
                                                <br/>
                                                <c:if test = "${requestScope.sort == 'SD' && requestScope.order == 1}">
                                                    <img class ="sort" src ="img/upIcon.png"/>
                                                </c:if>
                                                <c:if test = "${requestScope.sort == 'SD' && requestScope.order == 0}">
                                                    <img class ="sort" src ="img/downIcon.png"/>
                                                </c:if> 
                                                <c:if test = "${requestScope.sort != 'SD'}">
                                                    <img class ="sort" src =""/>
                                                </c:if> 
                                            </th>
                                            <th onclick = "sort('ED')">
                                                End Date 
                                                <br/>
                                                <c:if test = "${requestScope.sort == 'ED' && requestScope.order == 1}">
                                                    <img class ="sort" src ="img/upIcon.png"/>
                                                </c:if>
                                                <c:if test = "${requestScope.sort == 'ED' && requestScope.order == 0}">
                                                    <img class ="sort" src ="img/downIcon.png"/>
                                                </c:if> 
                                                <c:if test = "${requestScope.sort != 'ED'}">
                                                    <img class ="sort" src =""/>
                                                </c:if> 
                                            </th>
                                            ...
                                            <th onclick = "sort('Trainer')">
                                                Trainer 
                                                <br/>
                                                <c:if test = "${requestScope.sort == 'Trainer' && requestScope.order == 1}">
                                                    <img class ="sort" src ="img/upIcon.png"/>
                                                </c:if>
                                                <c:if test = "${requestScope.sort == 'Trainer' && requestScope.order == 0}">
                                                    <img class ="sort" src ="img/downIcon.png"/>
                                                </c:if> 
                                                <c:if test = "${requestScope.sort != 'Trainer'}">
                                                    <img class ="sort" src =""/>
                                                </c:if> 
                                            </th>
                                    ...
                                    <tbody>
                                        ...
                                        <c:forEach var="i" items="${requestScope.list}" varStatus="loop">
                                            <tr>
                                                ...
                                                <td>${i.getS().getSubjectCode()}</td>
                                                <td>${i.getSemester().getSetting_name()}</td>
                                                <td>${i.getStartS()}</td>
                                                <td>${i.getEndS()}</td>
                                                <td>${i.getDisplayOrder()}</td>
                                                <td>${i.getTrainer().getFullName()}</td>
                                                <td>
                                                ...
                                                <td>
                                                    ...
                                                    <a onclick ="upd('${i.getClassID()}', '${i.getS().getSubjectID()}', '${requestScope.page}')" class="settings" title="Update" data-toggle="tooltip"><img class ="a" src = "img/updateIcon.jpg"/></a> 
                                                        <c:if test = "${i.getActivate() == 1}">
        ...
        <script type = "text/javascript">
            ...
            function upd(id, subject, page) {
                window.location = "clist?id=" + id + "&sj=" + subject + "&page=" + page + "&act=upd";
            }
