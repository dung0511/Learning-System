    ...
    <body class = "skin-black">
        ...
        <aside class="right-side">
            <div class="container-xl">
                ...
                <div class = "ttle">Class's Assignment Details</div>
                <div class = "ttle">
                    <label for="asmName"></label>
                    <span>${classassignment.asmName}</span>
                    <input type="text" id="asmName" name="asmName" style="display: none;">
                </div>
                <div class = "in4">
                    <form action="ClassAssignmentUpdate" method="post" role="form" enctype="multipart/form-data">
                        ...
                        <div class = "insideF">
                            <div class = "searchAl">
                                <label style="color: #0077b6; font-size: 20px; font-style: italic;" class = "spn" for="chapter">Chapter:</label>
                                <span >${classassignment.subjectsetting.settingName}</span>
                                <input type="text" id="chapter" name="chapter" style="display: none;">
                            </div>
                            <div class = "searchA">
                                <label style="color: #0077b6; font-size: 20px; font-style: italic;" class = "spn">Deadline:</label>
                                <span >${classassignment.dl}</span>
                                <input type="datetime-local" name="dl" value="${classassignment.dl}" style="display: none;">
                            </div>
                            <div class = "searchAl">
                                <label style="color: #0077b6; font-size: 20px; font-style: italic;" class = "spn">Subject:</label>                    
                                <span >${classassignment.subject.subjectCode}</span>
                                <input type="text" name="subjectName" value="${classassignment.subject.subjectCode}" style="display: none;">
                            </div>
                            <div class = "searchA">
                                <label style="color: #0077b6; font-size: 20px; font-style: italic;" class = "spn">Created by:</label>
                                <span >${classassignment.createdBy.user}</span>
                                <input type="text" name="createdBy" value="${classassignment.createdBy.user}" style="display: none;">
                            </div>

                            <div class = "searchAl">
                                <label style="color: #0077b6; font-size: 20px; font-style: italic;" class = "spn">Class:</label>
                                <span >${classassignment.clas.className}</span>
                                <input type="text" name="clas" value="${classassignment.clas.className}" style="display: none;">
                            </div>

                            <div class = "searchA">
                                <label style="color: #0077b6; font-size: 20px; font-style: italic;" class = "spn">Created at:</label>
                                <span >${classassignment.createdAt}</span>
                                <input type="text" name="createdAt" value="${classassignment.createdAt}" style="display: none;">
                            </div> 

                            <div class = "searchAB">
                                <label  style="color: #0077b6; font-size: 20px; font-style: italic;" class = "spn" for="asmDes">Description:</label>
                                <span>${classassignment.asmDes}</span>
                                <input type="text" id="asmDes" name="asmDes" value="${classassignment.asmDes}" style="display: none;">
                            </div>
                        </div>
                        <button class ="btnS" type ="button" value ="Back"><a href = "ClassAssignList?page=1&size=5">Close</a></button>
