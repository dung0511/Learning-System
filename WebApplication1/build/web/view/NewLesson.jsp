        ...
        <aside class="right-side">
            <div class="container-xl">
                <c:if test = "${requestScope.add != null}">
                    <div class = "ttle">Add Lesson</div>

                    <div class = "in4">
                        <form action = "llist?act=add" id ="frm" method = "post" enctype="multipart/form-data">
                            ...
                            <div class = "insideF">
                                <div class = "searchAl">
                                    ...
                                    <select name = "subject" onchange = "type1()">
                                        <c:forEach items = "${requestScope.listS}" var = "i">
                                            <option ${requestScope.sID == i.getSubjectID()?"selected":""} value = "${i.getSubjectID()}">${i.getSubjectCode()}</option>
                                        </c:forEach>
                                    </select>
                                </div>
                                ...
                                <div class = "searchA">
                                    ...
                                    <select name ="chapter" onchange = "type1()">
                                        <c:forEach items = "${requestScope.listC}" var = "i">
                                            <option ${requestScope.chapterID == i.getChapterID()?"selected":""} value = ${i.getChapterID()}>${i.getChapterName()}</option>
                                        </c:forEach>
                                    </select>
                                </div>
                                <div class = "searchAl">
                                ...
                                <div  class = "searchA">
                                    ...
                                    <input class ="rdio" type ="radio" onclick ="check()" checked name ="type" value ="video"/><span class = "r">Video</span>
                                    <input class ="rdio" type ="radio" onclick ="check()" name ="type" value ="quiz"/><span class = "r">Quiz</span>
                                    <input class ="rdio" type ="radio" onclick ="check()" name ="type" value ="asm"/><span class = "r">Assignment</span>
                                </div>
                                <div class = "searchAl">
                                    <span class = "spn">Display Order</span>
                                    <input class ="inputText" type ="number" min ="0" max ="100" name ="order"/>
                                </div>
                                <div  class = "searchA">
                                    <span class = "r1">Status</span>
                                    <input class ="rdio" type ="radio" checked name ="status" value ="0"/><span class = "r">Inactive</span>
                                    <input class ="rdio" type ="radio" name ="status" value ="1"/><span class = "r">Active</span>
                                </div>
                                <div class = "searchAll">
                                    ...
                                    <select name = "class">
                                        ...
                                        <c:forEach items = "${requestScope.listCls}" var = "i">
                                            <option value = "${i.getClassID()}">${i.getClassName()} - ${i.getS().getSubjectCode()}</option>
                                        </c:forEach>
                                    </select>
                                </div>
                                <div class = "searchAl" id ="link">
                                    <span class = "spn">Video Link</span>
                                    <input class ="inputText"  type ="text" name ="link"/>
                                </div>
                                <div class = "searchAl" id = "file">
                                    <span class = "spn">  File:</span>
                                    <input class ="inputText" id ="fileI" onclick="takeF()" type ="file" name ="file1"/>
                                </div>
                                <div class = "searchAl" id ="quiz">
                                    ...
                                    <select name = "quiz" onchange = "type1()">
                                        <c:forEach items = "${requestScope.listQ}" var = "i">
                                            <option ${requestScope.quizID == i.getQuiz().getQuizID()?"selected":""} value = "${i.getQuiz().getQuizID()}">${i.getQuiz().getQuizName()}</option>
                                        </c:forEach>
                                    </select>
                                </div>
                                <div class = "searchAl" id = "asm">
                                    ...
                                    <select name = "asm" onchange = "type1()">
                                        <c:forEach items = "${requestScope.listA}" var = "i">
                                            <option ${requestScope.asmID == i.getAsm().getAsmID()?"selected":""} value = "${i.getAsm().getAsmID()}">${i.getAsm().getAsmName()}</option>
                                        </c:forEach>
                                    </select>
                                </div>
