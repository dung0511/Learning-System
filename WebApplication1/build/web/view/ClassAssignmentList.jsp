    ...
    <body class="skin-black">
        ...
        <aside class="left-side sidebar-offcanvas">
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li>
                        <a href="ClassAssignList?page=1&size=5">
        ...
        <aside class="right-side">
            <div class="container-xl">
                ...
                <form action="ClassAssignList"  method="get" class="middle">
                    Name: <input type="text" name="asmName" value="${asmName}" /> 
                    <button type="submit">Search</button>     
                    <a href="ClassAssignList?page=1&size=5">Clear</a>
                </form>
                <div class="table-responsive">
                    <div class="table-wrapper">
                        <div class="table-title">
                            <div class="row">
                                <div class="col-sm-5">
                                    <h2><b>Class Assignment List</b></h2>
                                </div>
                                <div class="col-sm-7">
                                    <a href="ClassAssignAdd" class="btn btn-secondary"><i class="material-icons">&#xE147;</i> <span>Add New Class Assignment</span></a>
                                </div>
                            </div>
                        </div>
                            ...
                            <tbody>
                                <c:forEach var="ca" items="${list}">
                                    <tr>
                                        <td>${ca.asmID}</td>
                                        <td>${ca.asmName}</td>
                                        <td>${ca.clas.className}</td>
                                        <td>${ca.subject.subjectCode}</td>
                                        <td>${ca.subjectsetting.settingName}</td>
                                        <td>${ca.dl}</td>
                                        <td>${ca.createdAt}</td>
                                        <td>
                                            <c:if test = "${ca.getStatus() == 1}">
                                                <span class="status text-success">&bull;</span> Active
                                            </c:if>
                                            <c:if test = "${ca.getStatus() == 0}">
                                                <span class="status text-warning">&bull;</span> Inactive
                                            </c:if>
                                        </td>
                                        <td>
                                            <a href="ClassAssignDetail?asmID=${ca.asmID}" class="settings" title="View" data-toggle="tooltip"><img class ="a" src = "img/viewIcon.jpg"/></a> 
                                            ...
                                            <form action="ClassAssignDelete" method="post" onsubmit="return confirmDelete();">
                                                <input type="hidden" name="asmID" value="${ca.asmID}">
                                            ...
                                            <script>
                                                function confirmDelete() {
                                                    return confirm("Do you want to delete this assignment ?");
                                                }
                                            </script>
                                        </td>
                        ...
                        <c:set var="msg" value="${null}" scope="session"></c:set>
                            ...
                            <ul class="pagination">
                                <li class="page-item"><a href="ClassAssignList?page=1&size=5" class="page-link">1</a></li>
                                <li class="page-item"><a href="ClassAssignList?page=2&size=5" class="page-link">2</a></li>
                                <li class="page-item"><a href="ClassAssignList?page=3&size=5" class="page-link">3</a></li>
                                <li class="page-item"><a href="ClassAssignList?page=4&size=5" class="page-link">4</a></li>
                                <li class="page-item"><a href="ClassAssignList?page=5&size=5" class="page-link">5</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
