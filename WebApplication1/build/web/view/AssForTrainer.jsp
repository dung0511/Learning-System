                                ...
                                <tbody>
                                    <c:forEach var="asm" items="${asmList}">
                                        <tr>
                                            ...
                                            <td>${asm.getDl()}</td>
                                            <td>${asm.getTotal_students()}</td>  
                                            <td>${asm.getSubmitted_students()}</td> 
                                            <td>${asm.getRemaining_students()}</td> 
                                            <td></td>
                                            <td class="">
                                                <a href="AssTrainerController?act=viewAss&subject=${requestScope.subject}&class=${requestScope.cl}&asmID=${asm.getAsmID()}" title="Evaluate" data-toggle="tooltip"><i class="fa fa-pencil"></i></a>
                                            </td>
                                        </tr>
                                    </c:forEach>    
                                </tbody>
