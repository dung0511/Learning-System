        ...
        <aside class="left-side sidebar-offcanvas" style="height:100%;">
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li>
                        <a href="AssTrainerController?subject=${requestScope.subject}&class=${requestScope.cl}&act=list">
                            <i class="fa fa-list"></i> <span>Assignment List</span>
                        </a>
                    </li>

                    <li>
                        <a href="TraineeQuizList?subjectId=${requestScope.subject}">
