                    ...
                    <div class="table-wrapper">
                        <div class="table-title">
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <form action="SearchUserMgn" method="get">
                                ...
                                <div class="col-sm-3">
                                    <a href="view/AddUser.jsp" class="btn btn-secondary"><i class="material-icons">&#xE147;</i> <span>Add New User</span></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <c:if test = "${requestScope.accountList != null}">
                                    ...
                                    <c:forEach var="account" items="${accountList}">
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="DeleteUser?username=${account.getUser()}" class="delete" title="Delete" data-toggle="tooltip"><i class="material-icons">&#xE5C9;</i></a>
                                                <a href="UpdateUser?userID=${account.getID()}&userStatus=${account.getActivate()}&index=${tag}" title="Update Actions"" data-toggle="tooltip"><i class="glyphicon glyphicon-refresh"></i></a>
                                            </td>
                                        </tr>
                                    </c:forEach>    
                                </tbody>
                            ...
                            <div class="clearfix">
                                ...
                                <ul class="pagination">
                                    <li class="page-item  ${(tag-1)<=0?"disabled":""}"><a href="SearchUserMgn?index=${(tag-1)}&txt=${txt}">Previous</a></li>
                                    <c:forEach begin="1" end ="${endP}" var="i">
                                        
                                        <li class="page-item ${tag==i?"active":""}"><a href="SearchUserMgn?index=${i}&txt=${txt}" class="page-link">${i}</a></li>
                                        
                                    </c:forEach>
                                        <li class="page-item ${(tag+1) > endP?"disabled":""}"><a href="SearchUserMgn?index=${(tag+1)}&txt=${txt}" class="page-link">Next</a></li>
