<%-- 
    Document   : addUser
    Created on : Sep 25, 2023, 7:39:38 PM
    Author     : Acer
--%>
...
<!--                      <div
                    ...
                    <ul class="nav nav-tabs">
                      <li class="nav-item">
                        <a href class="active nav-link">Add Profile</a>
                      </li>
                    </ul>
                    <div class="tab-content pt-3">
                      <div class="tab-pane active">
                        <form action ="/prj/AddUser" method ="post" class="form" novalidate>
                          <div class="row">
                            <div class="col">
                              <div class="row">
                                <div class="col">
                              ...
                              <div class="row">
                                ...
                                <div class="col">
                                  <div class="form-group">
                                    <label for="enroldate">Enrolled Date</label>
                                    <input
                                      class="form-control "
                                      type="date"
                                      name="enroldate"
