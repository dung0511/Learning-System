                        ...
                        <div class="full-screen-box">
                            <section class="panel">
                                ...
                                <div class="panel-body">
                                    <form action="QuestionAdd" method="post" role="form">
                                        ...
                                        <div class="form-group">
                                            <label >Topic:</label>
                                            <input type="text" name="topic" class="form-control"  placeholder="Content" required="">
                                        </div>
                                        <label for="answer">Answers:</label>
                                        <div id="answers">
                                            <div class="answer">
                                                <input type="text" name="answerOption[]" placeholder="Option" required>
                                                <input type="text" name="answerContent[]" placeholder="Answer Content" required>
                                                <input type="radio" name="isKey[]" value="1"> Correct
                                                <button type="button" onclick="removeAnswer(this)">Delete</button>
                                            </div>
                                        </div>
                                        ...
                                        <!--                                        <div class="form-group">
                                                                                    <label for="clas">Select Dimension:</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="displayOrder" class="form-control"  required="">
                                        </div>
                                        <div>
                                        ...
                                        <button type="submit" value="Add" class="btn btn-info" onclick="setRealTime()"  >Add</button>
                                        <a href="QuestionList?page=1&size=5" class="btn btn-info">Close</i></a>
                                    </form>
                                    ...
                                    <script>
                                        ...
                                        function handleSelect(elm) {
                                            if (elm.value !== "0") {
                                                // L?u giá tr? ?ã ch?n vào sessionStorage n?u nó không ph?i là "All".
                                                sessionStorage.setItem("selectedSubject", elm.value);
                                            }

                                            window.location = "QuestionAdd?subjectid=" + elm.value;
                                        }

                                        var savedSubject = sessionStorage.getItem("selectedSubject");
                                        if (savedSubject) {
                                        ...
                                        function addAnswer() {
                                            ...
                                            var newAnswer = document.querySelector('.answer').cloneNode(true);
                                        ...
                                        function removeAnswer(button) {
                                            ...
                                            var answersDiv = answerDiv.parentNode;
