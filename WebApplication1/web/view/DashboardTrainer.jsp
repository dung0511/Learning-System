                        ...
                        <header>
                            <style>
                                ...
                                .box {
                                    ...
                                    border-radius: 12px;
                                    padding: 10px; /* Kho?ng cch n?i dung t? vi?n */
                                }
                                ...
                                .class-name {
                                    color: #299be4; /* Mu xanh bi?n nh?t */
                                }

                                /* ??nh d?ng cho ngy b?t ??u v ngy k?t thc */
                                .dates {
                                    margin-top: 10px; /* Kho?ng cch t? tn l?p */
                                }
                                .blk{
                                    color: black;
                                    font-weight: bold;
                            ...
                            <div  class="box-container">
                                <c:forEach var="dashboard" items="${list}">
                                    <div  class="box">
                                        ...
                                        <div>
                                            <button class="btn btn-primary btn-addon btn-sm" onclick = "learn('${dashboard.getSubject()}', '${dashboard.getClassid()}')">
                                                Go to subject
                                            </button>
                                        </div>
                                    </div>
