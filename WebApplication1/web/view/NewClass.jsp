    ...
    <body class = "skin-black">
        ...
        <aside class="right-side">
            <div class="container-xl">
                ...
                <form action = "clist?act=add" id ="frm" method = "post" >
                    <div class = "insideF">
                        <div class = "searchAl">
                        ...
                        <div class = "searchA">
                            ...
                            <select name ="subject" >
                                <c:forEach items = "${requestScope.listS}" var = "i">
                                    <option ${requestScope.sj == i.getSubjectID()?"selected":""} value = ${i.getSubjectID()}>${i.getSubjectCode()}</option>
                                </c:forEach>
                            </select>
                        </div>
                        ...
                        <div class = "searchA">
                            ...
                            <select name ="semester" >
                                <c:forEach items = "${requestScope.listSS}" var = "i">
                                    <option ${requestScope.sem == i.getSetting_id()?"selected":""}  value = ${i.getSetting_id()}>${i.getSetting_name()}</option>
                                </c:forEach>
                            </select>
                        </div>
                        <div class = "searchAl">
                            <span class = "spn">Start Date: <span style = "color:red">*</span></span>
                            <input class ="inputText" required="" type ="date" min ="0" max ="100" name ="sd" value = "${requestScope.sd}"/>
                        </div><!-- comment -->
                        <div class = "searchA">
                            <span class = "spn">End Date: <span style = "color:red">*</span></span>
                            <input class ="inputText" required="" type ="date"  min ="0" max ="100" name ="ed" value = "${requestScope.ed}"/>
                        </div>
                        <div class = "searchAl">
                            <span class = "spn">Trainer: </span>
                            <select name ="trainer" >
                                <c:forEach items = "${requestScope.listT}" var = "i">
                                    <option ${requestScope.trainer == i.getID()?"selected":""}  value = ${i.getID()}>${i.getFullName()}</option>
                                </c:forEach>
                            </select>
                        </div>
                        <div  class = "searchA">
                        ...
                        <div class = "searchAB">
                            ...
                            <textarea class ="inputText" id ="txt" name ="description">${requestScope.description}</textarea>
                        </div>
