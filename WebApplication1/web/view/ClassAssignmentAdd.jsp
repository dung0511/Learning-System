                        ...
                        <div class="full-screen-box">
                            <section class="panel">
                                ...
                                <div class="panel-body">
                                    <form action="ClassAssignAdd" method="post" role="form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea id="asmName" name="asmName" rows="4" cols="50" placeholder="Type the name" required="" ></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label>Description:</label>
                                            <textarea id="asmDes" name="asmDes" rows="4" cols="50" placeholder="Type the description" required="" ></textarea>
                                        </div>
<!--                                        <textarea id="w3review" name="w3review" rows="4" cols="50"></textarea>-->
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="datetime-local" name="dl"   >
                                        </div>
                                        <div>
                                    ...
                                    <script>
                                        ...
                                        function handleSelect(elm) {
                                            ...
                                            window.location = "ClassAssignAdd?subjectid=" + elm.value;
                                        }
